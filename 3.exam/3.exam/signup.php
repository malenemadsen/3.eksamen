                        ...
                        <?php
                            if(isset($_GET["error"])){
                                if($_GET["error"] == "emptyinput"){
                                    ...
                                    echo "<p class='error'>Username cannot contain special characters</p>";
                                }
                                    ...
                                    echo "<p class='error'>Username or email is alredy in use</p>";
                                }
                                else if($_GET['error'] == "passwordweak"){
                                    echo "<p class='error'>Password i too weak</p>";
                                }
                            }
                        ?>
                </from>
